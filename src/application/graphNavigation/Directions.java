...
public class Directions {
    ...
    private String orderFollowRoad(String orders, String roadName, double meterTillNextOrder) {
        return orders + "Folgen Sie der " + roadName + " für " + MathematicOperations.round(meterTillNextOrder / 1000, 1) + "km" + lineSeparator;
    }

    private String orderNavigationFinished(String orders, double meterTillDestination) {
        orders = orders + lineSeparator + "Entfernung: " + MathematicOperations.round(meterTillDestination/1000, 1) + "km" + lineSeparator;
